...
ear. These proporties are difficult to define, but we refer to higher
order dependancies present in the signal. For instance, the rate of
...
Music highly strucutred in time and as such is particularly suitable
...
grayed rectangle represents the case where a reconstruction is
