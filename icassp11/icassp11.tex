...
included speech denoising~\cite{} and model
...
time-frequency bins.  In contrast, we define an imputation task where
there are many consecutive time frames missing.  
